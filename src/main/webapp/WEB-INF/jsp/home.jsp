...
<div class="homepage">
	<div class="homepage-hero">
		<img
			...
			src="https://w0.peakpx.com/wallpaper/206/893/HD-wallpaper-crime-scene-fantasy-bullets-background-police-knife.jpg"
			alt="homepage background image"
		/>
		<div class="homepage-hero__text">
			<h1 class="homepage-hero__text_title">Crime Reporting System</h1>
	...
	<div class="copyright">
		<p>Copyright © Harshal Chinchole.</p>
	</div>
</div>
